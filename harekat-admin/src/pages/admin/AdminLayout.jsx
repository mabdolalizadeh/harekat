...
const SUPER_ADMIN_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/assignments', label: 'تکالیف و تمرین‌ها', icon: AssignmentIcon },
      { to: '/quizzes', label: 'آزمونک‌ها و کوییزها', icon: QuizIcon },
      { to: '/exams', label: 'آزمون‌های پایانی', icon: ExamIcon },
      { to: '/evaluations', label: 'ارزیابی اساتید', icon: EvaluationIcon },
...
const TA_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/assignments', label: 'تکالیف دوره‌ها', icon: AssignmentIcon },
      { to: '/quizzes', label: 'آزمونک‌های دوره‌ها', icon: QuizIcon },
      { to: '/exams', label: 'آزمون‌ها و ثبت نمره', icon: ExamIcon },
      { to: '/evaluations', label: 'ارزیابی و نظرسنجی', icon: EvaluationIcon },
